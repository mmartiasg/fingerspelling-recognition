...
from src.constants import MAX_LENGHT_SOURCE, FEATURES_SIZE, LATENT_DIMS, DIM_EMBEDDINGS, TARGET_MAX_LENGHT, ATTENTION_HEADS, FEATURE_COLUMNS
from src.data_utils.dataset import VOCAB_SIZE
import math
from src.custom.metrics import SparseLevenshtein
from src.prod_models.Fingerspelling import FingerSpellingV1
...
def build_prod_transformer_model_v1(trial):
    ...
    encoder_decoder_model = FingerSpellingV1(attention_heads=ATTENTION_HEADS,
                                                ...
                                                decoded_output_dropout=DROPOUT_RATE_DECODER,
                                                output_dropout=DROPOUT_RATE_OUTPUT,
